...
const Icons = {
    ...
    Fax: (props: IconProps) => (
        <svg {...props} className="h-5 w-5 flex-shrink-0 text-[#FF0000]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 9V4h12v5M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2" />
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 14H6v6h12v-6z" />
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center group">
                                ...
                                <div className="ml-3 text-sm text-black">
                                    <span>Telp: +62 21 2903 5005 (Hunting)</span>
                                </div>
                            </div>
                            <div className="flex items-center group">
                                <Icons.Fax />
                                <div className="ml-3 text-sm text-black">
                                    <span>Fax: +62 21 2903 5132</span>
                                </div>
                            </div>
                            <div className="flex items-center group">
                                <Icons.Envelope />
